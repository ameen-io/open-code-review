...
- (Optional) Provide `--background-file ./requirements.md` to load the same context from a Markdown file (sanitised, recommended up to 8192 characters, and limited to 32768 characters). Takes precedence over `--background` when both are set.
